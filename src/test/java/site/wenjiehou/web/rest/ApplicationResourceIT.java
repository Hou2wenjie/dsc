...
public class ApplicationResourceIT {
    ...
    private static final State DEFAULT_STATE = State.CREATED;
    private static final State UPDATED_STATE = State.REVIEWING;

    private static final LocalDate DEFAULT_END = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_END = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_LAST_CHANGED = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_LAST_CHANGED = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application()
            .state(DEFAULT_STATE)
            .end(DEFAULT_END)
            .lastChanged(DEFAULT_LAST_CHANGED);
        return application;
    }
    /**
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application()
            .state(UPDATED_STATE)
            .end(UPDATED_END)
            .lastChanged(UPDATED_LAST_CHANGED);
        return application;
    }
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getState()).isEqualTo(DEFAULT_STATE);
        assertThat(testApplication.getEnd()).isEqualTo(DEFAULT_END);
        assertThat(testApplication.getLastChanged()).isEqualTo(DEFAULT_LAST_CHANGED);
    }
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].lastChanged").value(hasItem(DEFAULT_LAST_CHANGED.toString())));
    }
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.lastChanged").value(DEFAULT_LAST_CHANGED.toString()));
    }
    ...
    public void updateApplication() throws Exception {
        ...
        Application testApplication = applicationList.get(applicationList.size() - 1);
        assertThat(testApplication.getState()).isEqualTo(UPDATED_STATE);
        assertThat(testApplication.getEnd()).isEqualTo(UPDATED_END);
        assertThat(testApplication.getLastChanged()).isEqualTo(UPDATED_LAST_CHANGED);
    }
